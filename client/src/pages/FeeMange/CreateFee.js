      ...
      >
        <Form layout="horizontal" name="create-fee" onFinish={handleSubmit}>
          ...
          <Form.Item
            ...
            name="feeType"
          >
            <Select placeholder="Chọn loại phí" onChange={handleFeeTypeChange} style={{width: "100%"}}>
          ...
          {isParkingFee && (
            <Form.Item
              ...
              rules={[{ required: true, message: "Bắt buộc!" }]}
            >
              <Select placeholder="Chọn loại xe" style={{width: "100%"}}>
          ...
          <Form.Item
            ...
            rules={[{ required: true, message: "Bắt buộc!" }]}
          >
            <Select placeholder="Chọn trạng thái" onChange={handleStatusChange} style={{width: "100%"}}>
